		...
		<div id="" class="portfolio container-fluid">
			...
			<div id="form-div" class="portfolio">
				...
				<form action="./admin-add" method="post" id="form">
					...
					<input name="tracking_id" id="tracking_id" type="number" class="form-control" placeholder="Tracking ID" /><br><br>
					...
					<?php if (isset($errors)): ?>
						...
						<?php else: ?>
							...
							<div class="form-group">
								<label class="col-form-label" for="end_date">End date</label>
								<input name="end date" id="end_date" class="form-control" type="date">
							</div>
