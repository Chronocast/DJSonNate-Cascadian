...
<head>
	...
	<form action="./verify" id="verify"  method="post" class="form-horizontal">
        ...
        <div class="card card-container">
            ...
            <form id="tracking-form" class="form-track" action="" method="post" autocomplete="on">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-12"><input type="text" class="form-control" id="trackingID" placeholder="Enter your tracking ID" required autofocus>
					</div>
				</div>
				
				<!-- TRACK BUTTON -->
				<input class="btn btn-lg btn-primary btn-block btn-track" name="" id="track" type="submit" value="TRACK YOUR ORDER">
                </input>
