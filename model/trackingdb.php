...
class TrackingDB
{
    ...
    */
    ...
    function activeProjectDisplay()
    {
        ...
        $select = 'SELECT * FROM `track_content` INNER JOIN clients ON track_content.track_id = clients.track_id WHERE track_content.project_status=1 ORDER BY track_content.start_date';
